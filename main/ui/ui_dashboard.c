...
void ui_dashboard_create(void) {
    ...
    // Humidity
    lbl_hum = lv_label_create(scr_dashboard);
    ...
    // Battery Arc
    arc_batt = lv_arc_create(scr_dashboard);
    ...
    lbl_batt = lv_label_create(scr_dashboard);
...
void ui_dashboard_update(const char *wifi_ssid, const char *ip_addr,
    ...
    // Animate Temperature
    int parsed_temp = 0;
    sscanf(lv_label_get_text(lbl_temp), "%d", &parsed_temp); 
